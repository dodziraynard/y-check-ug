...
class VisionFlaggingTestCase(TestCase):
    ...
    def test_vision_right_green_flag1(self):
        ...
        assert SummaryFlag.objects.filter(
            adolescent=self.adolescent,
            label__name="VISION (RIGHT EYE)").first().get_final_colour() == Colors.GREEN.value
    ...
    def test_vision_right_red_flag1(self):
        ...
        assert SummaryFlag.objects.filter(
            adolescent=self.adolescent,
            label__name="VISION (RIGHT EYE)").first().get_final_colour() == Colors.RED.value
    ...
    def test_vision_left_green_flag1(self):
        ...
        assert SummaryFlag.objects.filter(
            adolescent=self.adolescent,
            label__name="VISION (LEFT EYE)").first().get_final_colour() == Colors.GREEN.value
    ...
    def test_vision_left_red_flag1(self):
        ...
        assert SummaryFlag.objects.filter(
            adolescent=self.adolescent,
            label__name="VISION (LEFT EYE)").first().get_final_colour() == Colors.RED.value
