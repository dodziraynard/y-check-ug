...
import { 
 ...
 export const add_question = (cation,title, type,subtitle,category,picture)=> async(dispatch)=>{
    try {
        dispatch({
        ...
        const { data } = await axios.post(
            ...
            {"cation":cation,"title":title,"type":type,"subtitle":subtitle, "category":category,"picture":picture},
            config
        );
