...
import SNRSchools from './pages/addSchoolPage/shs/SNRSchools';
import Communities from './pages/addSchoolPage/community/Communities';
...
const AppRoutes = () => {
    return (
        <Routes>
            ...
            <Route path='/get_all_shs'element={<SNRSchools/>}/>
            <Route path='/add_community'element={<AddCommunity/>}/>
            <Route path='/get_all_communities'element={<Communities/>}/>
